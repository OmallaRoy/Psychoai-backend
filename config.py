...
# ================================================================
# FILE: config.py
# Environment variable loading for Psychoai backend
#
# v1.2: Added TAVILY_API_KEY for web RAG enrichment
# ================================================================
...
WINDOW_SIZE          = 50
EMBED_DIM            = 64
NOTIFICATION_HOUR    = "08:00"   # daily notification time (UTC)

# ── v1.2: Tavily web search API key ───────────────────────────
# Get free tier key at: https://app.tavily.com
# Free tier: 1,000 credits/month — sufficient for startup beta.
# If not set, web search is silently disabled and coaching
# continues with Qdrant + Groq only (graceful degradation).
